...
def main():
    ...
    processing_times = [[3, 2, 2, 5, 6, 3, 2, 7],
                        [2, 1, 4, 8, 2, 1, 7, 3],
                        [4, 3, 6, 3, 5, 2]]
    ...
    # Creates sequence varibles and add disjunctive constraints
    all_sequences = []
    all_machine_jobs = []
    ...
    # Add the interesting variables to the SolutionCollcter
    ...
    if solver.Solve(main_phase, [objective_monitor, collector]):
        print "\nOptional Schedule Length:"+str(collector.ObjectiveValue(0))+"\n"
        sol_line = ""
        sol_line_tasks = ""
